...
const sendMail = require("../mailer/sendMail"); // ✅ Added
...
exports.userRegister = async (req, res) => {
  ...
  try {
    ...
    await sendMail(
      email,
      "Welcome to Hostel Complaint Portal 🎉",
      `Hi ${full_name}, welcome aboard!`,
      `<h3>Hello ${full_name},</h3><p>Thank you for registering as a ${type} on the Hostel Complaint Portal.</p>`
    );
